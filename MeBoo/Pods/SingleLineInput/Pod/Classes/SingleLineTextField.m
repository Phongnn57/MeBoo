...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        aFrame = CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width * [UIScreen mainScreen].bounds.size.width / 375 - 16, self.frame.size.height + offSetSizeTextField);
    }
    return self;
}
